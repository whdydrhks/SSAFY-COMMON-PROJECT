    ...
    <>
      ...
      {dateState !== undefined ? (
        <>
          ...
          <SContainer>
            <SClickButton onClick={handleSetDayTimeButton}>
              적용하기
            </SClickButton>
          </SContainer>
        </>
      ) : (
        <SStartText>요일을 선택하여 시간을 설정하세요.</SStartText>
      )}
    </>
  );
}
